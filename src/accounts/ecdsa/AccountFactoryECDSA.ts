...
export class AccountFactoryECDSA extends AccountFactory {
    ...
    public static buildSignKeyPairFromPrivateKey(privateKey: string | Uint8Array, curve: string): {compressed: IKeyPairBytes, uncompressed: IKeyPairBytes} {
